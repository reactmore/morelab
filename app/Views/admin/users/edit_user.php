...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- Main row -->
            <?php echo form_open_multipart('administrator/edit_user_post', ['id' => 'form_add_user_post', 'class' => 'custom-validation needs-validation']); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="mobile_no" class="form-control auth-form-input" placeholder="<?php echo trans("mobile_no"); ?>" value="<?php echo html_escape($user->mobile_no); ?>">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group mb-3">
