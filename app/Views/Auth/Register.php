    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="<?php echo base_url(); ?>/assets/admin/index2.html" class="h1"><b><?php echo get_general_settings()->application_name ?></b></a>
            </div>
            <div class="card-body">

                <?php echo $this->include('common/_messages') ?>
                <form id="form_safe" action="<?php echo base_url(); ?>/auth/register-post" method="post">
                    <?php echo csrf_field() ?>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="fullname" class="form-label"><?php echo trans('fullname') ?></label>
                                <input class="form-control" type="text" id="fullname" name="fullname" placeholder="<?php echo trans('form_username') ?>" value="<?php echo old('fullname') ?>" required>
                            </div>
                        </div>
                        <!-- /.col -->
                        <div class="col-6">
                ...
                <?php endif; ?>
                <p class="mb-0 mt-3 text-muted">Already have an account ? <a href="<?php echo base_url(); ?>/auth/login" class="font-weight-medium text-primary"> <?php echo trans('login') ?> </a> </p>
